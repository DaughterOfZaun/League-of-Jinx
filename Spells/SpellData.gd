...
func set_from_ini_entry(key_array: Array, value: String):
    match key_array:
        ["AfterEffectName"]: after_effect = effect_parse(value)
        ...
        ["CastRadiusSecondaryTexture"]: cast_radius_secondary_texture = tex_parse(value)
        ["CastRadiusTexture"]: cast_radius_texture = tex_parse(value)
        ...
        ["HitEffectName"]: hit_effect = effect_parse(value)
        ...
        ["PointEffectName"]: point_effect = effect_parse(value)
        ["RangeIndicatorTextureName"]: cast_range_indicator_texture = tex_parse(value)
