...
var null_callable := func() -> void: pass
...
var _disable_ambient_gold_ref_count := 0
...
var _ignore_call_for_help_ref_count := 0
...
var _reveal_specific_unit_ref_count := 0
